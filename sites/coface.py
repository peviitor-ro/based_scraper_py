...
_counties = GetCounty()
company = "Coface"
url = "https://api.smartrecruiters.com/v1/companies/Coface/postings?offset="
    ...
    for job in content:
        ...
        jobs.append(
            create_job(
                ...
                job_link="https://jobs.smartrecruiters.com/Coface/" + job.get("id"),
                company=company,
                country="Romania",
                city=city,
                county=county,
...
publish_logo(
    company,
    "https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/Coface_logo.svg/512px-Coface_logo.svg.png",
)
show_jobs(jobs)
