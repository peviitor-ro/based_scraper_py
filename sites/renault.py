...
data = {"appliedFacets":{"locationCountry":["f2e609fe92974a55a05fc1cdc2852122"],"workerSubType":["62e55b3e447c01871e63baa4ca0f9391","62e55b3e447c01140817bba4ca0f9891"]},"limit":20,"offset":0,"searchText":""}
...
for num in iteration:
    ...
    for job in jobs:
        ...
        job_link = "https://alliancewd.wd3.myworkdayjobs.com/ro-RO/renault-group-careers" + job.get("externalPath")
        company = "Renault"
        country = "Romania"
